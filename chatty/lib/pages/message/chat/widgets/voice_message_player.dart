...
/// 🎙️ INDUSTRIAL VOICE MESSAGE PLAYER V3
...
class _VoiceMessagePlayerState extends State<VoiceMessagePlayer>
  ...
  /// Build circular progress play/pause button (Telegram style)
  Widget _buildPlayButton(VoiceMessageService voiceService, Duration duration) {
    return Obx(() {
      ...
      return GestureDetector(
        onTap: () {
          voiceService.playVoiceMessage(widget.messageId, widget.audioUrl);
        },
  ...
  Widget _buildWaveform(VoiceMessageService voiceService, Duration duration) {
    return Obx(() {
      ...
      return GestureDetector(
        ...
        child: Container(
          height: 38.h, // 🔥 Increased by 10% for better visibility
                ...
                builder: (context, child) => Transform.scale(
                  ...
                  child: Container(
                    padding: EdgeInsets.symmetric(
                        horizontal: 6.w,
                        vertical: 1.h), // 🔥 Reduced padding by 2px
                    decoration: BoxDecoration(
                      color: widget.isMyMessage
                          ? Colors.white.withOpacity(0.2)
