...
class _BlockSettingsDialogWidgetState
    extends State<_BlockSettingsDialogWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _restrictions =
        widget.initialRestrictions ?? BlockRestrictions.standard();
